...
# ─── Model (Official Google AI — gemini-3.0-flash-preview) ───
# Source: https://ai.google.dev/gemini-api/docs/models/gemini-3.0-flash-preview
...
# ─────────────────────────────────────────────────────────────
# RATE LIMITS — gemini-3.0-flash-preview (Preview / Paid tier)
...
SYSTEM_INSTRUCTION = {
    "parts": [{
        "text": (
            ...
            "ردودك تكون طبيعية وذوية — مش روبوتية ولا رسمية.\n"
...
class SmartKeyOrchestrator:
    ...
    async def report_error(self, key: KeyState, status_code: msg: str):
        async with self.lock:
...
class GeminiClient:
    ...
    def _extract_thought_signature(self, data: Dict) -> Optional[str]:
        ...
        Source: https://ai.google.dev/gemini-api/docs/thought-signatures try:
